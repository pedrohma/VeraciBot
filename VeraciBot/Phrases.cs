...
namespace VeraciBot
{
    public class Phrases
    {
        ...
        public Phrases(IOpenAiActions openAiServices)
        {
            if (openAiServices == null)
            {
                throw new ArgumentNullException(nameof(openAiServices));
            }
        ...
        public async Task<string> GetTranslatePhraseFromArray(string[] array, string lang)
        {
            Random rnd = new Random();
            int index = rnd.Next(array.Length);
            return await _openAiServices.TranslatePhrase(array[index], lang);
        }

        public async Task<string> GetNotAuthorizedResponseAsync(string lang)
        {
        ...
        public async Task<string> GetFailedToUnderstandResponseAsync(string lang)
        {
            return await GetTranslatePhraseFromArray(failedToUnderstandResponse, lang);
        }

        public static string failedToUnderstandAcceptResponse =
            "Não entedi o que você quer. Você tem que aceitar ou recusar o convite antes de mais nada. Se quiser ajuda, peça ajuda.";

        public async Task<string> GetFailedToUnderstandAcceptResponseAsync(string lang)
        {
            return await _openAiServices.TranslatePhrase(failedToUnderstandAcceptResponse, lang);
        }
        ...
        public async Task<string> GetHelpResponseAsync(string lang)
        {
            return await _openAiServices.TranslatePhrase(helpResponse, lang);
        }
        ...
        public async Task<string> GetScoreResponseAsync(string lang)
        {
        ...
        public async Task<string> GetScoreBoardResponseAsync(string lang)
        {
        ...
        public async Task<string> GetInviteResponseAsync(string lang)
        {
            return await GetTranslatePhraseFromArray(inviteResponse, lang);
        }

        public static string inviteErrorResponse =
            "Esse tiraninho já foi convidado para o inquérito do fim do mundo! Ou já está jogando o jogo ou estamos lidando com ele de outra forma. Escolha outra vítima para suas ambições maquiavélicas!";

        public async Task<string> GetInviteErrorResponseAsync(string lang)
        {
            return await _openAiServices.TranslatePhrase(inviteErrorResponse, lang);
        }

        public static string inviteNoUserResponse =
            "Para convidar alguém, você precisa marcar o usuário que quer convidar, além do VERACIBOT. Não abuse da minha paciência suprema. Qualquer coisa é mais 14 anos de cadeia.";

        public async Task<string> GetInviteNoUserResponseAsync(string lang)
        {
            return await _openAiServices.TranslatePhrase(inviteNoUserResponse, lang);
        }
        ...
        public async Task<string> GetAcceptResponseAsync(string lang)
        {
        ...
        public async Task<string> GetRefuseResponseAsync(string lang)
        {
