...
namespace VeraciBot
{
    public class OpenAIAPI
    {
        ...
        /// <summary>
        /// Avalia uma thread e retorna a avaliação completa
        /// </summary>
        /// <param name="thread"></param>
        /// <returns></returns>
        public static async Task<FullEvaluation> CheckThread(ThreadContext thread)
        {
            using var client = new HttpClient();
            client.DefaultRequestHeaders.Authorization = new AuthenticationHeaderValue(
                "Bearer",
        ...
        /// <summary>
        /// Traduz uma frase para a lingua desejada
        /// </summary>
